"""Select entities for Candy program selection."""
...
from .const import (DATA_KEY_COORDINATOR, DEVICE_NAME_TUMBLE_DRYER,
                    DEVICE_NAME_WASHING_MACHINE, DOMAIN,
                    SUGGESTED_AREA_BATHROOM, SUGGESTED_AREA_KITCHEN)
