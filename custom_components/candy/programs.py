...
# Category strings use clean names (no numeric prefix) so HA dropdowns show
# 'Cycles', 'Baby Care', 'Home Care' instead of '1. Cycles', '2. Baby Care'.
# Sort order in the UI is controlled by sorted() in select.py, which happens
# to produce the same sensible alphabetical ordering.
# ---------------------------------------------------------------------------
...
# Same clean category names (no numeric prefix).
# ---------------------------------------------------------------------------
